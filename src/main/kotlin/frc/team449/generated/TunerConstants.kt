...
object TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    val kSpeedAt12Volts: LinearVelocity = Units.MetersPerSecond.of(4.43)
    ...
    private const val kInvertFL = true
    private const val kInvertFR = false
    private const val kInvertBL = false
    private const val kInvertBR = true
    ...
    private const val kFrontLeftSteerMotorId = 8
    private const val kFrontLeftEncoderId = 8
    private val kFrontLeftEncoderOffset: Angle = Units.Rotations.of(-0.20875)
    private const val kFrontLeftSteerMotorInverted = true
    private const val kFrontLeftEncoderInverted = true
    ...
    private const val kFrontRightEncoderId = 6
    private val kFrontRightEncoderOffset: Angle = Units.Rotations.of(-0.0444444444)
    private const val kFrontRightSteerMotorInverted = true
    private const val kFrontRightEncoderInverted = true

    private val kFrontRightXPos: Distance = Units.Inches.of(10.875)
    private val kFrontRightYPos: Distance = Units.Inches.of(-10.875)

    // Back Left
    private const val kBackLeftDriveMotorId = 4
    private const val kBackLeftSteerMotorId = 5
    private const val kBackLeftEncoderId = 5
    private val kBackLeftEncoderOffset: Angle = Units.Rotations.of(-0.0512777778)
    private const val kBackLeftSteerMotorInverted = true
    private const val kBackLeftEncoderInverted = true

    private val kBackLeftXPos: Distance = Units.Inches.of(-10.875)
    private val kBackLeftYPos: Distance = Units.Inches.of(10.875)

    // Back Right
    private const val kBackRightDriveMotorId = 2
    private const val kBackRightSteerMotorId = 7
    private const val kBackRightEncoderId = 7
    private val kBackRightEncoderOffset: Angle = Units.Rotations.of(-0.18775)
    private const val kBackRightSteerMotorInverted = true
    private const val kBackRightEncoderInverted = true
    ...
    val FrontLeft: SwerveModuleConstants<TalonFXConfiguration, TalonFXSConfiguration, CANcoderConfiguration> =
        ConstantCreator.createModuleConstants(
            ...
            kFrontLeftXPos, kFrontLeftYPos, kInvertFL, kFrontLeftSteerMotorInverted, kFrontLeftEncoderInverted
        )
    ...
    val BackLeft: SwerveModuleConstants<TalonFXConfiguration, TalonFXSConfiguration, CANcoderConfiguration> =
        ConstantCreator.createModuleConstants(
            ...
            kBackLeftXPos, kBackLeftYPos, kInvertBL, kBackLeftSteerMotorInverted, kBackLeftEncoderInverted
        )
    val BackRight: SwerveModuleConstants<TalonFXConfiguration, TalonFXSConfiguration, CANcoderConfiguration> =
        ConstantCreator.createModuleConstants(
            kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset,
            kBackRightXPos, kBackRightYPos, kInvertBR, kBackRightSteerMotorInverted, kBackRightEncoderInverted
        )
}
