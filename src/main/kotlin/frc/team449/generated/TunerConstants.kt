...
object TunerConstants {
    ...
    private val kWheelRadius: Distance = Units.Inches.of(1.8906)
    ...
    private val kFrontLeftEncoderOffset: Angle = Degrees.of(-139.83)
    ...
    private val kFrontRightEncoderOffset: Angle = Degrees.of(102.66)
    ...
    private val kBackLeftEncoderOffset: Angle = Degrees.of(-106.87)
    ...
    private val kBackRightEncoderOffset: Angle = Degrees.of(111.36)
