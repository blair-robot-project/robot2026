...
object RobotContainer {
    ...
    fun configureFuelSim() {
        ...
        instance.registerRobot(
            Constants.FuelSimDimensions.FULL_WIDTH.`in`(Meters),
            Constants.FuelSimDimensions.FULL_LENGTH.`in`(Meters),
            Constants.FuelSimDimensions.BUMPER_HEIGHT.`in`(Meters),
            { drive.getPose() },
            drive::getFieldRelativeSpeeds,
        )

        instance.registerIntake(
            Constants.FuelSimDimensions.FULL_LENGTH
                .div(2.0)
                .`in`(Meters),
            Constants.FuelSimDimensions.FULL_LENGTH
                .div(2.0)
                .plus(Inches.of(3.0))
                .`in`(Meters),
            -Constants.FuelSimDimensions.FULL_WIDTH
                .div(2.0)
                .minus(Inches.of(2.0))
                .`in`(Meters),
            Constants.FuelSimDimensions.FULL_WIDTH
